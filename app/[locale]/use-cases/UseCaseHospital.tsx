        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 tracking-tight leading-tight mb-6">
              Coordinate critical care and <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-blue-500">
                emergency response.
              </span>
            </h2>
            <p className="text-lg text-slate-500">
              Comprehensive hospital management system that coordinates across
              multiple departments, manages emergency response, and ensures
              critical care delivery at scale.
            </p>
          </motion.div>
        </div>
...
const VisualEmergencyCoordination = () => (
    ...
    <div className="flex gap-3 w-full">
      ...
      <div className="flex-1 bg-white p-3 rounded-xl shadow-sm border border-slate-200 flex flex-col gap-2">
        <div className="flex justify-between items-center">
          <span className="text-[10px] font-bold text-slate-400">ER BAY 2</span>
          <div className="w-1.5 h-1.5 rounded-full bg-yellow-400" />
        </div>
        <div className="flex items-center gap-2">
          <Users className="w-4 h-4 text-slate-600" />
          <span className="text-xs font-medium text-slate-700">Stable</span>
        </div>
      </div>
    </div>
    ...
    <div className="flex gap-3 w-full">
      <div className="flex-1 bg-white p-3 rounded-xl shadow-sm border border-slate-200 flex flex-col gap-2 opacity-60">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-medium text-slate-500">Monitoring</span>
        </div>
      </div>
      <div className="flex-1 bg-white p-3 rounded-xl shadow-sm border border-slate-200 flex flex-col gap-2 opacity-60">
        <div className="flex justify-between items-center">
...
const VisualHospitalAlerts = () => (
  <div className="w-full h-full flex flex-col justify-center items-center gap-3 w-full max-w-[260px] mx-auto">
    ...
    >
      ...
      <div>
        <div className="text-xs font-bold text-slate-700">
          Blood Bank Restocked
        </div>
        <div className="text-[10px] text-slate-400">All types available</div>
      </div>
    </motion.div>
  </div>
);
