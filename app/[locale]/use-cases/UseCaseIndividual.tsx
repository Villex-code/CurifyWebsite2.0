...
const UseCaseIndividual = ({ segment }: { segment: string }) => {
  // For now, we force the content to be about "Clinics" as requested
  // regardless of the selection, to demonstrate the layout.
    ...
    >
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          >
            ...
            <p className="text-lg text-slate-500">
              A unified command center for your entire facility. Track patient
              flow, automate stock, and manage staff from a single pane of
              glass.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 mb-12">
          {/* CARD 1: LIVE MONITORING (Room Status) */}
          <VisualCard delay={0}>
...
// ============================================================================
// ABSTRACT UI VISUALS (The "Screens")
// ============================================================================
