...
const Card1 = () => {
  ...
  const benefits = [
    {
      icon: <Building2 className="w-4 h-4 sm:w-5 sm:h-5 text-teal-600" />,
      text: t("card1.benefits.centralized"),
    },
    {
      icon: <Users2 className="w-4 h-4 sm:w-5 sm:h-5 text-teal-600" />,
      text: t("card1.benefits.staff"),
    },
    {
      icon: <Brain className="w-4 h-4 sm:w-5 sm:h-5 text-teal-600" />,
      text: t("card1.benefits.ai"),
    },
    {
      icon: <Clock className="w-4 h-4 sm:w-5 sm:h-5 text-teal-600" />,
      text: t("card1.benefits.resource"),
    },
  ];
